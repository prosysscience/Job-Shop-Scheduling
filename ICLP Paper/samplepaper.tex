...
\setlength\listingnumberwidth{\widthof{\scriptsize 00} + 7pt}
% \setlength{\mathindent}{\listingnumberwidth}

\usepackage{listings}
\lstset{numberbychapter=false,numbers=left,numberblanklines=false,basicstyle=\ttfamily\small,numbersep=7pt,%xleftmargin=5ex,
...
%
\lstinputlisting[float=bt,mathescape=true,escapeinside={\#(}{\#)},basicstyle={\ttfamily\small},label=prg:encoding,caption={Multi-shot ASP modulo DL encoding}]{listing/encoding.lp}
