...
%       & {}        & \multicolumn{6}{c}{Group of Instances}  \\
    Window(s) & Comparison & 50$\times$15 & 50$\times$20 & 100$\times$20 \\
                     
    \hline\\[-2.75mm]
    1                & Makespan             & 3542.1   & 3879.4	     &  46786.1 \\
                     & CPU(Sec)             & 1000.0	& 1000.0   & 1000.0	     	    \\
                     & Interrupted Calls    & 1.0	    & 1.0      & 1.0	       \\[1.5mm]
                     
    2                & Makespan             & 3149.7   & 3479.4	      & 23977.5 \\
                     & CPU(Sec)             & 1000.0	    & 1000.0	   & 1000.0	      \\
                     & Interrupted Calls    & 2.0	    & 2.0      & 2.0	      \\[1.5mm]
                     
    3                & Makespan             & \textbf{3083.8}   & 3290.5	    & 7201.5 \\
                     & CPU(Sec)             & 1000.0	    & 1000.0	   & 1000.0	      \\
                     & Interrupted Calls    & 3.0	    & 3.0      & 3.0	      \\[1.5mm]
                     
    4                & Makespan             & 3110.7   & \textbf{3260.3}	   & 6288.7 \\
                     & CPU(Sec)             & 934.4	    & 944.9	   & 1000.0	      \\
                     & Interrupted Calls    & 3.6	    & 3.5      & 4.0	      \\[1.5mm]
                     
    5                & Makespan             & 3213.6   & 3355.5    & 6106.1 \\
                     & CPU(Sec)             & 615.5	    & 583.4	   & 1000.0	      \\
                     & Interrupted Calls    & 2.7	    & 2.5      & 5.0	      \\[1.5mm]
                     
    6                & Makespan             & 3225.3   & 3414.8	      & \textbf{6031.9} \\
                     & CPU(Sec)             & 243.8	    & 321.5	   & 1000.0	      \\
                     & Interrupted Calls    & 1.0	    & 1.6      & 6.0	      \\[1.5mm]
                     
    7                & Makespan             & 3350.5   & 3540.3	      & 6094.1 \\
                     & CPU(Sec)             & 146.7	    & 161.4	   & 1000.0	      \\
                     & Interrupted Calls    & 0.6	    & 0.9      & 7.0	      \\[1.5mm]
                     
                     
    8                & Makespan             & 3378.5   & 3561.5	      & 6053.1 \\
                     & CPU(Sec)             & 81.0	    & 54.9	   & 1000.0	      \\
                     & Interrupted Calls    & 0.3	    & 0.2      & 8.0	      \\[1.5mm]
                     
                     
    9                & Makespan             & 3495.0   & 3720.7	      & 6095.9 \\
                     & CPU(Sec)             & 45.6	    & 38.0	   & 977.0	      \\
                     & Interrupted Calls    & 0.1	    & 0.2      & 8.2	      \\[1.5mm]
                     
                     
    10               & Makespan             & 3524.9   & 3793.1	      & 6234.0 \\
                     & CPU(Sec)             & 18.5	    & 33.3	   & 861.8	      \\
                     & Interrupted Calls    & 0.1	    & 0.1      & 7.9	      \\[1.5mm]
...
\multirow{2}*{Strategy} & \multicolumn{3}{c}{50$\times$15} & \multicolumn{3}{c}{50$\times$20} & \multicolumn{3}{c}{100$\times$20}\\
    ...
    \hline\\[-2.75mm]
    Static machine-based EST              & \boldmath{$3083.8$}  & $1000.0$   & $3.0$	& \boldmath{$3260.3$}      & $944.9$ & $3.5$ & \boldmath{$6031.9$} & $1000.0$ & $6.0$\\
    [1.5mm]

    Static time-based EST             & $3524.8$ & $1000.0$   & $2.0$	   & $3540.8$      & $1000.0$ & $2.0$ & $6964.4$ & $1000.0$ & $4.0$\\ 
    [1.5mm]

    Static time-based MTWR             & $3456.2$  & $1000.0$   & $2.0$	& $3561.0$      & $1000.0$ & $2.0$ & $7149.6$ & $1000.0$ & $4.0$\\ 
    [1.5mm]

    Dynamic machine-based EST             & $3098.4$  & $1000.0$   & $3.0$	& $3309.5$     & $1000.0$ & $3.3$ & $6115.1$ & $1000.0$ & $6.9$\\ 
    [1.5mm]
