...
into balanced time windows \hl{(the number of operations assigned to each time window is equal)}, which respect the operation precedence within jobs and
...
\hl{Figure~{\ref{fig:enum}} summarizes the main steps of the Multi-shot solving controlled by a python script.}

\begin{tcolorbox}[title={The main steps of the Multi-shot solving},breakable,arc=0mm,outer arc=0mm,colbacktitle=lightgray!50!white,coltitle=black,colframe=gray,fonttitle=\bfseries,colback=white,subtitle style={colback=white}]
  \vspace{0.1\baselineskip}
  \begin{enumerate}
    \item[\textbf{1-}] Ground the base program.
    \item[\textbf{2-}] Ground the next shot.
    \item[\textbf{3-}] Optimize the current window till reaching the optima or the timeout.
    \item[\textbf{4-}] Apply the compression of a window (postprocessing phase).
    \item[\textbf{5-}] Keep the operations assignment to be passed to the next window.
    \item[\textbf{6-}] Go to \textbf{2} until all windows are optimized.
  \end{enumerate}
\end{tcolorbox}
\captionof{figure}{Main Steps of \textit{Multi-shot}\label{fig:enum}}
...
$50\times15$, $50\times20$, or $100\times20$ jobs and machines. \hl{We have selected the largest set of instances generated and excluded the small instances because they could be solved by the existing methods and applying decomposition leads to unnecessary overheads.}
...
%     \hline\\[-2.75mm]
    \midline
    0\%              & $3013.3$  & $972.3$   & $3.7$	   & $3186.8$      & $940.8$ & $3.3$ & $5713.0$ & $989.2$ & $8.6$\\
    % [1.5mm]
                     
    10\%             & $2970.2$  & $1000.0$   & $4.0$	   & $3149.8$      & $1000.0$ & $4.0$ & $5656.0$ & $1000.0$ & $9.0$\\ 
    
    20\%             & $2952.2$  & $1000.0$   & $4.0$	   & \boldmath{$3147.7$}      & $1000.0$ & $4.0$ & \boldmath{$5619.2$} & $1000.0$ & $9.0$\\ 
    
    30\%             & \boldmath{$2943.1$}  & $1000.0$   & $4.0$	   & $3162.2$      & $1000.0$ & $4.0$ & $5857.0$ & $1000.0$ & $9.0$%\\ 
                     % [1.5mm]
    \botline %\hline
    \end{tabular}
   % }
...
\begin{table}[t]
  ...
  \topline%\hline
  \multirow{3}{*}{Instances} & \multicolumn{4}{c}{Makespan} & \multicolumn{3}{c}{Distance measures} \\
  & Optima & OR-tools & \multicolumn{2}{c}{ASP} & OR-tools & \multicolumn{2}{c}{ASP} \\

  & & & Single-shot & Multi-shot &  & Single-shot & Multi-shot \\

  $50\times15$ & $2733.8$ & $2778.8$ & $3542.1$ & $2943.1$ & $5.0$ & $768.3$ & $169.3$ \\
  $50\times20$ & $2843.9$ & $2914.3$ & $3879.4$ & $3147.7$ & $70.4$ & $1035.5$ & $303.8$ \\
  $100\times20$ & $5365.7$ & $5559.3$ & $46786.1$ & $5619.2$ & $193.6$ & $41420.4$ & $253.5$
...
w.r.t.\ deadlines, which are crucial in many application areas. \hl{Furthermore, it would be beneficial to apply the same approach to Flow-shop and open-shop scheduling problems. However, the proposed model must be changed to solve open-shop since the precedence constraint is not applied}
