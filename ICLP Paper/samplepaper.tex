...
For identifying a collection of rules to instantiate,
the input language of \clingo supports \lstinline{#program name(c).}
directives, where the constant~\lstinline{c} is a placeholder for some value, e.g.,
the current time step in case of a planning problem,
supplied upon instantiating the rules below such a directive.
