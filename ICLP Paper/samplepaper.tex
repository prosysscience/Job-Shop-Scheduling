...
\newcommand{\ksverify}[1]{\textcolor{red}{#1}}
\makeatletter
\def\fcapsize@figure{\normalfont\normalsize\rmfamily}
...
\lstinputlisting[float=t,label=prg:decomposition,caption={J-EST decomposition encoding}]{listing/decomposition.lp}
% Only 
...
versions M-EST$^\text{\,d}$ and M-MTWR$^\text{\,d}$.
