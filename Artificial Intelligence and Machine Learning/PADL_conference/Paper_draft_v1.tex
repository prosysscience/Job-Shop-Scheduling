...
partitioning decisions, which can consist of overlapping time windows to enable
...
considering flexible machine allocations or partially ordered operations,
can also be relevant for practical application scenarios.
