...
\item \textbf{F10}\phantom{\textbf{0}} \textrightarrow{} \textit{\{ \stfifo, \stmtwr, \stest, \wtfifo, \wtmtwr, \wtest, RPT \}} 
...
as indicated by the virtual best clustering results in the last row of Table~\ref{tab4}. In Table~\ref{tab5}, the feature sets outperformed the greedy on only three out of ten instances. However, feature set \textbf{F6} provided the best obtained average. 
...
Data mining approaches~\cite{ismail2012production} have been extensively proposed and studied to generate % so-called
