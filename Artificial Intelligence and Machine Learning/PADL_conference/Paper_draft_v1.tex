...
Clustering algorithms are unsupervised learning methods whose goal is to partition a set of objects into (disjoint) subsets, called clusters, such that each cluster contains the most similar objects. 
